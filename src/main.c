/*
Presenter Timer Mod
From the work of fediskhakov:
https://github.com/fediskhakov/pebble_presenter_timer

This version simply adds more incriments to the amount of minutes
*/
...
static uint16_t Intervals[]={1,2,3,4,5,6,7,8,10,15,20,30,45,60,90,120,180,360};
#define nInterval 18
